...
<body>
    <?php
        $con=mysqli_connect("localhost","root","","clothes1");
        ...
        if(isset($_POST['submit']))
        {
            ...
            Your Cart value is    $total


            Copyrights by 2022 All Rights Reserved by InfinitexAgro .
            ...
            Regards ,
            Team Total InfiniteXagro'";
            $from = "infinitexagro@gmail.com";
            $headers = "From : $from";
      ...
      //  echo "insert into order_master values('',$uid,'$uname','$address','$zipcode','$phone','$email',$subtotal,$total,0)";
            $q=mysqli_query($con,"insert into order_master values('',$uid,'$uname','$address','$zipcode','$phone','$email',$total,'$odate',0)");
            if ( $q)
             {
        ...
        <div class="d-flex">
            ...
            <form action="" method="POST">
                <label>
                    ...
                    <input type="text" name="uname" id="uname" value="<?php echo $row1['fname'];?>">
                </label>
                <label>
